...
class Dashboard extends Component
{
    ...
    public function rules() { return [
        ...
        'editing.role' => 'required|in:'.collect(User::ROLES)->keys()->implode(','),
    ]; }
    ...
    {
        return User::make(['name' => 'Dummy name']);
    }
    ...
    public function getRowsQueryProperty()
    {
        $query = User::query()->with('company')
            ->when($this->filters['role'], fn($query, $status) => $query->where('status', $status))
